 ...
 */
package de.olumix.iunxtio.util;

/**
 * @author Holger Kremmin
 * This class is used to store global constants, enums etc. for using across different classes
 */
public final class LumixUtils {
	
public static enum Focus{NEARFAST, NEAR, FAR, FARFAST}
